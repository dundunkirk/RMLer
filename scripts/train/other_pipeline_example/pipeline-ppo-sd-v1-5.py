...
SD15_MODEL_PATH = os.environ.get(
    "RMLER_SD15_MODEL",
    str(CHECKPOINT_DIR / "stable-diffusion-v1-5"),
)
...
device1 = "cuda:0"
device2 = "cuda:1"
pipeline = StableDiffusionPipeline.from_pretrained(SD15_MODEL_PATH, revision="main", torch_dtype=torch.float16)
...
if __name__ == "__main__":
    ...
    floder_path = OUTPUT_DIR / "res_ppo_0804_abo" / "sd-v1-5"
